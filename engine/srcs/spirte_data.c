...
/*   Updated: 2019/10/22 22:09:01 by zytrams          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initilize_abs_sprt_sizes(t_player *plr)
{
	...
	*plr->arr_sizes = (t_sprts_size *)ft_memalloc(sizeof(t_sprts_size) * 12);
	plr->arr_sizes[0][MEDKIT] = (t_sprts_size){10.f, 40.f, 0.f};
	plr->arr_sizes[0][ARMOR] = (t_sprts_size){10.f, 40.f, 0.f};
	...
	plr->arr_sizes[0][BARREL] = (t_sprts_size){20.f, 120.f, 0.f};
	plr->arr_sizes[0][AFRIT] = (t_sprts_size){20.f, 260.f, 0.f};
	plr->arr_sizes[0][CACODEMON] = (t_sprts_size){40.f, 200.f, 10.f};
