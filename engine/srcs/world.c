...
void		engine_create_test_world(t_world **world)
{
	...
	*world = (t_world *)ft_memalloc(sizeof(t_world));
	...
	(t_point_3d){100, -100, 0}, (t_point_3d){100, -100, 100});
	...
	(*world)->sectors_array[0].objects_array[2] = engine_create_obj_wall(1, (t_point_3d){100, 100, 300}, (t_point_3d){100, 100, 0},
	...
	(t_point_3d){ -200, 200, 0}, (t_point_3d){ -200, 200, 200});
	(*world)->sectors_array[1].objects_array[3] = engine_create_obj_wall(-1, (t_point_3d){ -200, 200, 150}, (t_point_3d){-200, 200, 0},
	(t_point_3d){-100, 100, 0}, (t_point_3d){-100, 100, 150});
